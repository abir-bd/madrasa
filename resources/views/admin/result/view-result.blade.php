          ...
          @endif
            ...
            <div class="pannel" style="background-color:white;border-bottom: 5px solid #605ca8 ;margin-bottom: 20px;">
             <div class="pannel-header" style="background-color: #605ca8;color: white;padding: 10px">
                <h5>Result
                 <button type="button" class="btn btn-warning float-right btn" data-toggle="modal" data-target="#addStudent"><i class="fa fa-plus-circle"></i> Add Result</button>
                </h5>
              </div>
            <div class="card-body">
  ...
  <div class="modal fade" id="addStudent" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-small">
          <div class="modal-content"style="background-color:#d9dad6;border-bottom: 5px solid #605ca8 ;">
            ...
            <form method="post" action="{{route('admin.result.store')}}" id="myform">
                @csrf

                <div class="form-group row">
                    <label for="role_id"  class="col-sm-3 col-form-label">Class Name</label>
                  <div class="col-sm-9">
                    <select name="class_id" id="class_id" class="form-control" autocomplete="off" value="{{old('class_id')}}">
                ...
                <div class="col-sm-9">
                   <input type="text" name="name" id="name" class="form-control" placeholder="Enter Exam Name" autocomplete="off" value="{{old('name')}}">
                 ...
                 <div class="col-sm-9">
                    <input type="file" name="name" id="name" class="form-control" placeholder="Enter Result" autocomplete="off" value="{{old('name')}}">
                     <font style="color:red">{{($errors)->has('name')?($errors->first('name')):''}}</font>
                  </div>
                </div>
